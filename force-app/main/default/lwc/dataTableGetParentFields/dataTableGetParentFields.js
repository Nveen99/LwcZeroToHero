...
export default class DataTableGetParentFields extends LightningElement {
                      ...
                      // console.log('data length:'+this.data.length);
                       console.log('result from Apex:', JSON.stringify(result));
                        ...
                        this.data=result.map(item=>{
                            return{...item, AccountId :item.Account!=undefined ? item.Account.Name:'',
                            AccPhone :item.Account!=undefined ? item.Account.Phone:'',
                            AccRating :item.Account!=undefined ? item.Account.Rating:''
                        }
                        });
